...
baam = [[0,0]]      #(0,0) 인덱스로 시작  #현재 뱀이 있는 위치   #문제는 1,1로 시작이지만 (0,0)으로 시작하기
...
#Point
#dx,dy + nx,ny + 바라보는 방향 설정!!!! 중요!!      #dx[look] ,dy[look] 표현도 중요!!
#시작점 설정!!
#While True: 로 시물레이션 시작!!
#공간을 벗어나는 조건 4가지 설정!!!

#뱀의 길이가 변할수도 있으면서 이동하기 때문에 -> 큐로 풀기!!!